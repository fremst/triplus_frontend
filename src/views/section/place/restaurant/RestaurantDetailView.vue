...
export default {
  ...
  methods: {
    getDetail() {
      axios
        .get(`http://localhost:8082/triplus/api/section/places/restaurant/${this.$route.params.brdNum}`, this.data, {
          headers: {
    ...
    deleteSelectedProducts(value) {
      ...
      axios.delete(`http://localhost:8082/triplus/api/section/places/restaurant/${this.$route.params.brdNum}`, this.data,{
        headers: {
          "Access-Control-Allow-Origin": "*"
        },
      })
