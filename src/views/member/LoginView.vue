    ...
    <div class="inner">
      <div class="layout">
        ...
        <div class="login_findpwd">
          아이디 또는 비밀번호를 잊었습니까? <a href="#" @click.prevent="goFind">아이디 비밀번호 찾기</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
        ...
        success: function () {
          window.Kakao.API.request({
            ...
            success: async function (response) {
              ...
              axios
                .get("http://localhost:8082/triplus/member/identifyid", {
                  headers: {
                ...
                .then(
                  function (resp) {
                    if (resp.data.result === "success") {
                      ...
                      axios
                        .post("http://localhost:8082/triplus/api/memberjoin/sns", joinparam, {
                          headers: {
                            "Access-Control-Allow-Origin": "*"
                          }
                        })
    ...
    login() {
      ...
      axios
        .post(`http://localhost:8082/triplus/api/member/login/${this.id}`, joinparam, {
          headers: {
            "Access-Control-Allow-Origin": "*"
          }
        })
