<template>
  <div class="login">
    ...
    <div class="login-form">
      ...
      <div><Button type="submit" label="로그인" class="p-button-secondary" @click.prevent="login" /></div>
      <!--<input type="submit" value="로그인" @click.prevent="login"><br>  -->
    
    </form>

      <div class="login_insert">아직 회원이 아닙니까?  <a href="#" @click.prevent="">회원 가입하기</a></div>
