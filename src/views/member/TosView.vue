...
<p>
   ...
   <div class="first-chk"><input type="checkbox" v-model="chk1"> 위의 이용약관에 동의합니다.</div>
    </div>
  ...
  <div class="col-12 md:col-4 p-5" style="width:100%;border:1px solid #ccc; ">
    <ScrollPanel style="width: 100%; height: 200px" class="custombar1">
      ...
      <div class="second-chk"><input type="checkbox" v-model="chk2"> 위의 개인정보 수집 및 이용에 대한 안내에 동의합니다.</div>
    </div>

</div>
<div class="last-chk"><input type="checkbox" v-model="chk3"> 위의 이용약관 및 개인정보 수집 및 이용에 대한 안내에 동의합니다.</div>
<div class="btn">
 <Button  type="button" label="확인" class="p-button-primary" @click.prevent="nextPage(event)"/>
 <Button  label="취소" class="p-button-outlined" />
</div>
</div>
