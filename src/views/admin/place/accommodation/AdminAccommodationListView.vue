<template>
  <div class="wrap">
    ...
    <div class="inner">
      <div class="title">
        <h2 style="color: #009688">숙소 목록</h2>
      </div>
      <hr />
      <div>
        <div class="card">
          ...
          >
            ...
            <Column header="숙소이미지" style="min-width: 5rem">
            ...
            <Column :sortable="true" field="title" header="숙소명" style="min-width: 9rem; text-align: center">
              <template #body="slotProps">
