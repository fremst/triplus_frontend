...
export default {
  ...
  methods: {
    onUpdate() {
      ...
      this.article = axios
        .get(`${this.link}/${tempBrdNum}/password`, {
          headers: {
    ...
    onDelete() {
      ...
      axios
        .delete(`${this.link}/${this.$route.params.brdNum}/${this.pwd}`, "", {
          headers: {
            "Access-Control-Allow-Origin": "*"
          }
        })
    ...
    getArticle() {
      this.article = axios
        .get(`${this.link}/${this.$route.params.brdNum}`, {
          headers: {
            "Access-Control-Allow-Origin": "*"
          },
          params: {
    ...
    getReplyList() {
      axios
        .get(`${this.link}/${this.$route.params.brdNum}/reply`, {
          headers: {
            "Access-Control-Allow-Origin": "*"
          },
          params: {
    ...
    inputPassword() {
      axios
        .get(`${this.link}/${this.$route.params.brdNum}/password`, {
          headers: {
            "Access-Control-Allow-Origin": "*"
          },
          params: {
